...
Friend Structure TeacherRecord
    Dim id, ic, name, email, phone As String
    Dim dob As Date
End Structure
Public Class Teacher
    ...
    Friend Function getTeacherRecord(id) As TeacherRecord
        ...
        Try
            ...
            End If
        Catch
            MessageBox.Show("Error accessing student record for student with matric :" & id)
            con.Close()
            Return teacherRec
        End Try
        Return teacherRec
    ...
    Friend Function addTeacher(newTeacherRec As TeacherRecord) As Boolean
        Try
            ...
            Else
                ...
                Exit Function
            End If
            sql = "insert into teacher(idNumber,icNumber,name,dateOfBirth,phoneNumber)"
            sql = sql & " values('" & newTeacherRec.id & "','" & newTeacherRec.ic & "','" & newTeacherRec.name & "','" & newTeacherRec.dob & "','" & newTeacherRec.phone & "')"
